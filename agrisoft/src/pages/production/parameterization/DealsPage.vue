<template>
    ...
    <div
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-3xl font-black text-slate-800 tracking-tight">Gestión de Tratos</h1>
                <p class="text-slate-500 font-medium font-inter">Configuración de precios y condiciones por formato de
                    cosecha</p>
            </div>
        </div>
    </div>
