<template>
    ...
    <div class="max-w-11/12 mx-auto mb-6 flex justify-between items-center pl-2 md:pl-5">
        <div class="flex flex-col">
            <h1 class="text-2xl font-light text-navy-700 dark:text-white">Exportadoras</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400">
                Exportadoras registradas en el sistema
            </p>
        </div>
    </div>
    ...
    <div class="mt-[3px] flex w-full flex-grow items-center justify-around gap-2 rounded-2xl
        ...
        <DxDataGrid ref="mainGridRef" :data-source="dataSource" key-expr="id" :show-borders="true"
            ...
            <DxColumn data-field="name" caption="Razon Social" css-class="!text-left" />
            <DxColumn data-field="city" caption="Ciudad" css-class="!text-left" />
            ...
            <DxColumn data-field="state" caption="Región" :set-cell-value="setStateValue" :visible="false">
            ...
            <DxEditing mode="popup" :allow-adding="true" :allow-updating="true" :allow-deleting="true"
                :use-icons="true">
                <DxPopup title="Gestión de Exportadoras" :show-title="true" :width="900" :height="750" />
                ...
                <DxForm :col-count="2">
                    ...
                    <DxSimpleItem item-type="group" caption="Información Corporativa" :col-span="2" :col-count="2">
                        ...
                        <DxItem data-field="name" caption="Razón Social"
                ...
                { type: 'required', message: 'El RUT es obligatorio' },
                {
                    ...
                    validationCallback: (e) => validarRutChileno(e.value)
                        ...
                        <DxItem data-field="web" caption="Sitio Web" :validation-rules="[
                            { message: 'El sitio web es obligatorio' },
                            {
                                type: 'custom',
                    ...
                    <!-- ================= UBICACIÓN ================= -->
                    <DxSimpleItem item-type="group" caption="Ubicación y Contacto" :col-span="1" :col-count="1">
                    ...
                    <DxSimpleItem item-type="group" caption="Representante Legal" :col-span="1" :col-count="1">
                        ...
                        <DxItem data-field="legal_representative_rut" caption="RUT" editor-type="dxTextBox"
                            :editor-options="{
                                valueChangeEvent: 'input',
                                onInput(e) {
                                    const formatted = formatearRutConPuntos(e.event.target.value)
            ...
            <div class="max-h-96 overflow-y-scroll pr-2">
                <div class="space-y-2">
                    <div
                        ...
                        <img :src="selectedItem?.logo || noFoundImg" alt="Logo Empresa"
...
const dataSource = new CustomStore({
    key: 'id',
    load: async () => {
        const { data } = await conexionApi.get('/configuracion/production/getExporters/' + companyID)
        console.log(data);
    ...
    insert: async (values) => {
        ...
        console.log(payload);
        const { data } = await conexionApi.post('/configuracion/production/getExporters', payload)
