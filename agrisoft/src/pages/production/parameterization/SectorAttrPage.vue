<template>
    <div class="mb-8 p-6 bg-white rounded-3xl border border-slate-100 shadow-sm flex items-center justify-between">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-3xl font-black text-slate-800 tracking-tight">Atributos de Sector</h1>
                <p class="text-slate-500 font-medium font-inter">Administración de atributos de sectores y cuarteles de
                    producción</p>
            </div>
        </div>
    </div>
