    ...
    <DxDataGrid ref="mainGridRef" :data-source="dataSource" key-expr="id" :show-borders="true" :column-auto-width="true"
      ...
      <DxEditing mode="popup" :allow-adding="true" :allow-updating="true" :allow-deleting="true" :use-icons="true"
        ...
        <DxForm>
          ...
          <!--
          <DxItem item-type="simple" caption="Stock por bodega" :col-span="2">
            <template #default>
              <DxDataGrid :data-source="warehousesStock" key-expr="warehouse_id" height="300" :show-borders="true"
                :editing="{
                  mode: 'cell',
                ...
                <DxColumn data-field="warehouse_name" caption="Bodega" :allow-editing="false" />
                <DxColumn data-field="quantity" caption="Cantidad" data-type="number" :allow-editing="canEdit" />
              </DxDataGrid>
            </template>
</DxItem>
-->
